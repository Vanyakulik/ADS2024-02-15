package by.it.group310902.drapeza.lesson03;
...
public class Lesson03Test {
    ...
    */
    ...
    public void checkA() throws Exception {
        ...
        File f = new File(root + "by/it/group310902/kulik/lesson03/dataHuffman.txt");
    ...
    public void checkB() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        File f = new File(root + "by/it/group310902/kulik/lesson03/encodeHuffman.txt");
    ...
    public void checkC() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        InputStream stream = new FileInputStream(root + "by/it/group310902/kulik/lesson03/heapData.txt");
